...
type (
	// A Kind represents the specific kind of type
	// that a Type represents. The zero Kind is not
	// a valid kind.
	//
	...
	// KindInfo stores information about each kind of type.
	KindInfo struct {
...
func (k KindInfo) IsComparable() bool     { return k.comparable }
func (k KindInfo) IsOrdered() bool        { return k.ordered }
func (k KindInfo) IsIterable() bool       { return k.iterable }
func (k KindInfo) IsDeepComparable() bool { return k.deeplyComparable }
func (k KindInfo) HasAlternate() bool     { return k.alternate }

func (k KindMap) IsComparable(key Kind) bool     { return k[key].IsComparable() }
func (k KindMap) IsOrdered(key Kind) bool        { return k[key].IsOrdered() }
func (k KindMap) IsIterable(key Kind) bool       { return k[key].IsIterable() }
func (k KindMap) IsDeepComparable(key Kind) bool { return k[key].IsDeepComparable() }
func (k KindMap) HasAlternate(key Kind) bool     { return k[key].HasAlternate() }

// KindMap is a map of the different kinds of types in Go and
